...
from fraudGT.graphgym.config import (cfg, makedirs_rm_exist)
from fraudGT.graphgym.optimizer import OptimizerConfig
...
def make_wandb_name(cfg):
    ...
    if dataset_name in ['GNNBenchmarkDataset', 'TUDataset', 'OGB_MAG']:
    ...
    if cfg.posenc_Hetero_RWSE.enable:
        model_name += "+Hetero_RWSE"
